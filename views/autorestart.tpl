...
<script>
$(document).ready( function() { togglemodal(); starttimer(); callrestart(); });
</script>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Refreshing Services...</h4>
                </div>
                <div class="modal-body">
                    <p>Please wait while services are refreshed.</p>
